const TopNavTabs = () => {
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 bg-[#F5F5F5]">
      <ul className="flex justify-end text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li className="mr-2">
          <a
            href="#"
